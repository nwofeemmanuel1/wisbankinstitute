...
const findVideo=async(id)=>{
    const response=await fetch("/api/videos/list/single",{
    method:"POST",
...
console.log(result)
 if(result.error ==true)return window.location.href=`/videoStore.html`
...
h3.innerHTML=result.message.video_name
// p.className="description"
p.innerHTML=result.message.video_description
